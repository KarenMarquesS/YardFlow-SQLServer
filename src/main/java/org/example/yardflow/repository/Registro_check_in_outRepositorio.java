...
public interface Registro_check_in_outRepositorio extends JpaRepository<Registro_check_in_out, Integer> {
    ...
    Optional<Registro_check_in_out> findTopByMoto_IdmotoAndSaidapatioIsNullOrderByEntradapatioDesc(int idmoto);

    // Encontra o último registro (fechado ou não) pela moto
    Optional<Registro_check_in_out> findTopByMoto_IdmotoOrderByEntradapatioDesc(int idmoto);
