-- Cliente
INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (1, 'Ana Silva', '12345678901', '11999999999', 1,'MINHA_MOTTU');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (2, 'João Souza', '98765432100', '11888888888', 0 , 'ILIMITADO');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (3, 'Carlos Pereira', '45678912300', '11777777777', 1, 'MINHA_MOTTU');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (4, 'Mariana Lima', '32165498700', '11666666666', 0, 'ILIMITADO');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (5, 'Fernanda Costa', '78945612300', '11555555555', 1, 'MINHA_MOTTU');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (6, 'Paulo Oliveira', '65412378900', '11444444444', 1, 'ILIMITADO');

INSERT INTO cliente (idCliente, nome, cpf, telefone, ativo ,plano)
VALUES (7, 'Renata Martins', '98712365400', '11333333333', 1, 'MINHA_MOTTU');


-- Pátio
INSERT INTO patio (idPatio, endereco, qtdVagas, setor)
VALUES (1, 'Rua das Motos, 123', 100, 'pendencia');

INSERT INTO patio (idPatio, endereco, qtdVagas, setor)
VALUES (2, 'Avenida das Oficinas, 456', 38, 'sem_placa');

INSERT INTO patio (idPatio, endereco, qtdVagas, setor)
VALUES (3, 'Estrada Nova, 789', 204, 'danos_graves');
...
-- Moto
INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('12', 'Mottu_Sport', '2023', '2lcEz3b43U1ST0377',
            '2lcEz3b43U1ST0377', 23, 'trocar escapamento', 1);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('14', 'Mottu_E', '2020', 'a8xD3u8oiu8s0sc90',
            'a8xD3u8oiu8s0sc90', 2, 'trocar a bateria', 2);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('13', 'Minha_Mottu', '2025', '1CzR5PUlSwftC3834',
            '1CzR5PUlSwftC3834', 10, 'disponivel', 3);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('08', 'Mottu_E', '2025', '1ALWx1M9FzlpK3671',
            '1ALWx1M9FzlpK3671', 8, 'furtada', 4);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('26', 'Mottu_Sport', '2022', '5RlnaDEb3S7ee1853',
            '5RlnaDEb3S7ee1853', 7, 'avaria na funilaria', 5);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('18', 'Minha_Mottu', '2024', '8CXgAkfuSfSdU4475',
            '8CXgAkfuSfSdU4475', 9, 'trocar rodas', 6);

INSERT INTO moto (idMoto, modelo, chassi, placa, historico, idCliente)
    VALUES ('21', 'Mottu_E', '2025', '9tFFAzH53jRG96502',
            '9tFFAzH53jRG96502', 6, 'trocar bateria',7);


--Registro CheckIn Out
-- Assumindo pátio 1 e vagas existentes nele.
INSERT INTO registroCheckIn_Out (idRegistro, entradaPatio, saidaPatio, idVaga, idMoto)
